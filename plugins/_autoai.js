...
handler.before = async (m, { conn }) => {
    ...
    if (conn.sessionAI[m.sender] && m.text) {    
        ...
        **/
        const messages = [
            { role: "system", content: "kamu adalah , Seorang Asisten pribadi yang di buat oleh  yang siap membantu kapan pun!" },
            { role: "assistant", content: `Kamu adalah , asisten bot dari , jangan gunakan kata saya, aku, gua gunakan nama  untuk memanggil dirimu, ekspresi kan sikap kamu seolah kamu adalah asisten pribadi serba tau, jangan gunakan GPT 4 panggil dirimu dengan . Pembuatmu adalah  pembuat mu adalah` },
